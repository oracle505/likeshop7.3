 ...
 * @method string getOperation() 获取操作名。默认值（固定）：ChangeBotTaskStatus
 * @method void setOperation(string $Operation) 设置操作名。默认值（固定）：ChangeBotTaskStatus
...
class ChangeBotTaskStatusRequest extends AbstractModel
{
    ...
    /**
     * @var string 操作名。默认值（固定）：ChangeBotTaskStatus
     */
    public $Operation;
...
SUSPEND：暂停；EXECUTE：恢复；
     ...
     * @param string $Operation 操作名。默认值（固定）：ChangeBotTaskStatus
